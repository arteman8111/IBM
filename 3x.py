...
dm2 = 3 # Диаметр мидаля 2 ступени
dm3 = 1.5 # Диаметр мидаля 3 ступени
da1 = 1.49 # Диаметр выходного сечения сопла 1 ступени
da2 = 1.445 # Диаметр выходного сечения сопла 2 ступени
da3 = 1.345 # Диаметр выходного сечения сопла 3 ступени
Lp1 = 9.557 # Длина 1 ступени
Lp2 = 3.101 # Длина 2 ступени
Lp3 = 3.039 # Длина 3 ступени
Lgh = 2.848 # Длина ГЧ
Lp = Lp1 + Lp2 + Lp3 + Lgh # Полная длина ракеты

P01 = 1623.415e+3 # Тяга 1 ступени
P02 = 601.674e+3 # Тяга 2 ступени
P03 = 311.338e+3 # Тяга 3 ступени
msec1 = 674.653 # Массовый расход первой ступени
msec2 = 213.266 # Массовый расход второй ступени
msec3 = 110.182 # Массовый расход второй ступени
tk1 = 114.026 # Конец АУТ 1 ступени
tk2 = tk1 + 119.526 # Конец АУТ 2 ступени
tk3 = tk2 + 63.042 # Конец АУТ 3 ступени

mGH = 4840 # Масса ГЧ
m01 = 88443 # Масса 1 ступени
m02 = 33345.34 # Масса 2 ступени
m03 = 12572.07 # Масса 3 ступени
mk01 = 11515.2 # Масса консрукции 1 ступени
mk02 = 7854.44 # Масса консрукции 2 ступени
mk03 = 5625.98 # Масса консрукции 3 ступени

rhoRG, lyRG, muRG, nuRG = rg(psi,thet,gama)
VECTOR = [t,V,thetc,psic,fi,ly,thet,psi,gama,alpha,betta,wx,wy,wz,vxg,vyg,vzg,xg,yg,zg,vx,vy,vz,r,m01+m02+m03+mGH,rhoRG,lyRG,muRG,nuRG]
XLSX = [[t],[V],[thetc],[psic],[fi],[ly],[thet],[psi],[gama],[alpha],[betta],[wx],[wy],[wz],[vxg],[vyg],[vzg],[xg],[yg],[zg],[vx],[vy],[vz],[r],[m01+m02+m03+mGH]]
